...
void TCM2208Register_Read(uint8_t address)
{
		...
		writeData[1] = TMC2208_SLAVE_ADDR;						 // Slave address
...
//	TMC2208_CLEAR_BIT(temp, MOTOR_STANDBY_CURENT);
	TMC2208_SET_BIT(temp, MOTOR_STANDBY_CURENT|MOTOR_RUN_CURENT);
...
//	TCM2208Register_Write(TMC2208_FACTORY_CONF, 0x00000300); //157¶È
	TCM2208Register_Write(TMC2208_CHOPCONF, 0x10000283);
	TCM2208Register_Write(TMC2208_PWMCONF, 0xC10D0024);
//	TMC2208_Resolution_Set(RESOLUTION_32);

	TMC2208_Standby_curent();
	TCM2208Register_Write(TMC2208_TPWMTHRS, 0);
	TCM2208Register_Write(TMC2208_VACTUAL, 0);
	TCM2208Register_Write(TMC2208_TCOOLTHRS, 0x000FFFFF);
	TCM2208Register_Write(TMC2208_SGTHRS, 0X0);
	TCM2208Register_Write(TMC2208_COOLCONF, 0x0000C569);
