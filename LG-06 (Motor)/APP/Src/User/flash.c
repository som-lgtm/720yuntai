...
void write_flash_holfword_buffer(uint32_t address, uint16_t *data, uint16_t sizes)
{
	...
	if(sizes > 0x400)
	{
		data_len = (sizes - 0x400)/2; // 除2 是因为半字写存
		data_len1 = 0x400 / 2;
		temp1 = 1;
	}
	else
